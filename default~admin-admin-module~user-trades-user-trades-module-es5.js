(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-admin-module~user-trades-user-trades-module"], {
    ...
    /***/
    function VLI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function jW6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TradeFeedComponent", function () {
        return TradeFeedComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_trade_feed_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./trade-feed.component.html */
      "bmOs");
      /* harmony import */
      ...
      var TradeFeedComponent = /*#__PURE__*/function () {
        function TradeFeedComponent(http) {
          _classCallCheck(this, TradeFeedComponent);
        ...
        _createClass(TradeFeedComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this = this;

            this.subscriptions.add(Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["timer"])(1, 10 * 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () {
              return _this.http.get('/trades/feed');
      ...
      TradeFeedComponent.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
        }];
      };

      TradeFeedComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'trade-feed',
    ...
    /***/
    function yNi(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TradesModule", function () {
        return TradesModule;
      });
      /* harmony import */
      ...
      var ngx_countdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ngx-countdown */
      "z+xu");
      /* harmony import */
      ...
      var _trade_feed_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./trade-feed.component */
      "9jW6");
      /* harmony import */


      var _trade_form_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./trade-form.component */
      "VEyS");
      /* harmony import */


      var _trade_quote_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./trade-quote-modal.component */
      "IQn0");

      var TradesModule = /*#__PURE__*/_createClass(function TradesModule() {
        _classCallCheck(this, TradesModule);
      });

      TradesModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function IQn0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TradeQuoteModalComponent", function () {
        return TradeQuoteModalComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_trade_quote_modal_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./trade-quote-modal.component.html */
      "9VLI");
      /* harmony import */
      ...
      var TradeQuoteModalComponent = /*#__PURE__*/function () {
        function TradeQuoteModalComponent(activeModal) {
          _classCallCheck(this, TradeQuoteModalComponent);
        ...
        _createClass(TradeQuoteModalComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
          ...
          key: "baseCurrency",
          get: function get() {
            var parts = this.trade.symbol.split('/');
            return parts[0];
          }
        }, {
          key: "counterCurrency",
      ...
      TradeQuoteModalComponent.ctorParameters = function () {
        return [{
      ...
      TradeQuoteModalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    /***/
    function VEyS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TradeFormComponent", function () {
      ...
      var _raw_loader_trade_form_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./trade-form.component.html */
      "smW1");
      /* harmony import */
      ...
      var src_app_store_wallets_wallets_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/store/wallets/wallets.service */
      "hOWo");
      /* harmony import */


      var _security_check_security_check_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var _trade_quote_modal_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./trade-quote-modal.component */
      "IQn0");

      var TradeFormComponent = /*#__PURE__*/function () {
        function TradeFormComponent(ngbModal, http, session, toastr, walletsService, securityCheckService, translate) {
          var _this2 = this;

          _classCallCheck(this, TradeFormComponent);
          ...
          this.usersStream = this.userAutocomplete.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(function (search) {
            return _this2.http.get('/users', {
              params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('limit', '25').set('search', search)
            });
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (results) {
        ...
        _createClass(TradeFormComponent, [{
          key: "requestQuote",
          ...
          key: "submitRequestQuote",
          value: function submitRequestQuote() {
            var _this3 = this;
            ...
            this.securityCheckService.getScopePermission('banking').subscribe(function () {
              ...
              _this3.requestQuote().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["finalize"])(function () {
                _this3.isLoading = false;
              })).subscribe(function (trade) {
                _this3.openQuoteModal(trade);
              });
            });
          }
        }, {
          ...
          value: function executeTrade(trade) {
            ...
            this.isLoading = true;
            this.http.post('/trades', Object.assign(Object.assign({}, trade), {
              userId: (_b = (_a = this.user) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : this.session.user.id
            })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["finalize"])(function () {
              _this4.isLoading = false;
            })).subscribe(function () {
              _this4.toastr.success(_this4.translate.instant('trade-form.trade-executed'));

              _this4.onTrade.emit();

              _this4.walletsService.fetch();

              _this4.form.resetForm({
                symbol: _this4.trade.symbol,
                side: _this4.trade.side,
                quantity: null
              });
            });
          }
          ...
          value: function openQuoteModal(trade) {
            ...
            var modal = this.ngbModal.open(_trade_quote_modal_component__WEBPACK_IMPORTED_MODULE_12__["TradeQuoteModalComponent"], {
            ...
            component.onExecute.subscribe(function () {
              _this5.executeTrade(component.trade);

              modal.close();
            });
            component.onCountdown.subscribe(function () {
              _this5.requestQuote().subscribe(function (t) {
                component.trade = t;
      ...
      TradeFormComponent.ctorParameters = function () {
        return [{
      ...
      TradeFormComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'trade-form',
    ...
    /***/
    function bmOs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function smW1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=default~admin-admin-module~user-trades-user-trades-module-es5.js.map