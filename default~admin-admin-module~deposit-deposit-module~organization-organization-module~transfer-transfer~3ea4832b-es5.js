(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-admin-module~deposit-deposit-module~organization-organization-module~transfer-transfer~3ea4832b"], {
    ...
    /***/
    function FiSU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Fpzr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function P4TK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EmailInviteModalComponent", function () {
        return EmailInviteModalComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_email_invite_modal_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./email-invite-modal.component.html */
      "Fpzr");
      /* harmony import */
      ...
      var EmailInviteModalComponent = /*#__PURE__*/_createClass(function EmailInviteModalComponent(activeModal) {
        _classCallCheck(this, EmailInviteModalComponent);
      ...
      EmailInviteModalComponent.ctorParameters = function () {
        return [{
      ...
      EmailInviteModalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    /***/
    function oMaD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "BeneficiaryBookComponent", function () {
        return BeneficiaryBookComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_beneficiary_book_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./beneficiary-book.component.html */
      "FiSU");
      /* harmony import */
      ...
      var _beneficiary_form_beneficiary_form_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../../beneficiary-form/beneficiary-form.component */
      "2qAm");
      /* harmony import */


      var _list_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../../list.component */
      "aJRI");
      /* harmony import */
      ...
      var BeneficiaryBookComponent = /*#__PURE__*/function (_list_component__WEBP) {
        _inherits(BeneficiaryBookComponent, _list_component__WEBP);

        var _super = _createSuper(BeneficiaryBookComponent);

        function BeneficiaryBookComponent(http, ngbModal, changeDetector, route, router, session, confirmation, modal, toastr, translate) {
          var _this;

          _classCallCheck(this, BeneficiaryBookComponent);

          _this = _super.call(this, http, ngbModal, changeDetector, route, router, session, confirmation);
          _this.modal = modal;
          _this.toastr = toastr;
          _this.translate = translate;
          _this.onSelect = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
          _this.defaultLimit = 5;
          _this.isLoading = false;
          _this.isSaving = false;
          _this.isDeleting = false;
          _this.faTimes = _fortawesome_pro_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__["faTimes"];
          _this.faPencil = _fortawesome_pro_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__["faPencil"];
          return _this;
        }

        _createClass(BeneficiaryBookComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.apiUrl = "/users/".concat(this.session.user.id, "/beneficiaries");
            this.queryParams = {
              type: {
                eq: 'template'
              }
            ...
            _get(_getPrototypeOf(BeneficiaryBookComponent.prototype), "ngOnInit", this).call(this);
          }
        }, {
          key: "openBeneficiaryForm",
          value: function openBeneficiaryForm(beneficiary) {
            var _this2 = this;

            var modal = this.ngbModal.open(_beneficiary_form_beneficiary_form_component__WEBPACK_IMPORTED_MODULE_9__["BeneficiaryFormComponent"], {
              backdrop: 'static',
              windowClass: 'modal-primary'
            });
            var form = modal.componentInstance;
            form.compact = true;
            form.item = beneficiary; // Only display methods that are applicable to the user
            ...
            form.onDelete.subscribe(function () {
              modal.close();
          ...
          key: "delete",
          value: function _delete(beneficiary) {
            var _this3 = this;
            ...
            this.confirmation.show({
              ...
              return _this3.http["delete"]("/beneficiaries/".concat(beneficiary.id));
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["finalize"])(function () {
              _this3.isDeleting = false;
            })).subscribe(function () {
              _this3.toastr.success(_this3.translate.instant('common.beneficiary-deleted'));
        ...
        return BeneficiaryBookComponent;
      }(_list_component__WEBPACK_IMPORTED_MODULE_10__["ListComponent"]);

      BeneficiaryBookComponent.ctorParameters = function () {
        return [{
      ...
      BeneficiaryBookComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function qIFn(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PaymentFormModule", function () {
      ...
      var _beneficiary_book_beneficiary_book_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./beneficiary-book/beneficiary-book.component */
      "oMaD");
      /* harmony import */


      var _email_invite_modal_email_invite_modal_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./email-invite-modal/email-invite-modal.component */
      "P4TK");
      /* harmony import */


      var _payment_confirmation_payment_confirmation_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./payment-confirmation/payment-confirmation.component */
      "n93W");

      var PaymentFormModule = /*#__PURE__*/_createClass(function PaymentFormModule() {
        _classCallCheck(this, PaymentFormModule);
      });

      PaymentFormModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=default~admin-admin-module~deposit-deposit-module~organization-organization-module~transfer-transfer~3ea4832b-es5.js.map