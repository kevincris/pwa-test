(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-spot-trading-user-spot-trading-module"], {
    ...
    /***/
    function zRn(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UserSpotTradingComponent", function () {
        return UserSpotTradingComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_user_spot_trading_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./user-spot-trading.component.html */
      "vmZF");
      /* harmony import */
      ...
      var src_app_store_wallets_wallets_query__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/store/wallets/wallets.query */
      "O9sj");
      /* harmony import */


      var _common_list_v2_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var UserSpotTradingComponent = /*#__PURE__*/function (_common_list_v2_compo) {
        _inherits(UserSpotTradingComponent, _common_list_v2_compo);

        var _super = _createSuper(UserSpotTradingComponent);

        function UserSpotTradingComponent(http, ngbModal, changeDetector, route, router, session, toastr, walletsQuery) {
          var _this;

          _classCallCheck(this, UserSpotTradingComponent);
          ...
          _this.apiUrl = "/users/".concat(_this.session.user.id, "/spot-trades");
          _this.wallets$ = _this.walletsQuery.filteredBalances$;
          return _this;
        }

        _createClass(UserSpotTradingComponent, [{
          ...
          value: function getCounterCurrency(instrument) {
            if (!instrument) {
              return '';
            }
          ...
          key: "onExecuteTrade",
          value: function onExecuteTrade() {
            this.updateEvent.next();
          }
        }]);

        return UserSpotTradingComponent;
      }(_common_list_v2_component__WEBPACK_IMPORTED_MODULE_8__["ListV2Component"]);

      UserSpotTradingComponent.ctorParameters = function () {
        return [{
      ...
      UserSpotTradingComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function MWcC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UserSpotTradingModule", function () {
        return UserSpotTradingModule;
      });
      /* harmony import */
      ...
      var _common_spot_trading_spot_trading_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../common/spot-trading/spot-trading.module */
      "B25w");
      /* harmony import */
      ...
      var _user_spot_trading_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./user-spot-trading-routing.module */
      "pf/W");
      /* harmony import */


      var _user_spot_trading_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./user-spot-trading.component */
      "/zRn");

      var UserSpotTradingModule = /*#__PURE__*/_createClass(function UserSpotTradingModule() {
        _classCallCheck(this, UserSpotTradingModule);
      });

      UserSpotTradingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function pfW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UserSpotTradingRoutingModule", function () {
        return UserSpotTradingRoutingModule;
      });
      /* harmony import */
      ...
      var _user_spot_trading_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./user-spot-trading.component */
      "/zRn");
      ...
      var UserSpotTradingRoutingModule = /*#__PURE__*/_createClass(function UserSpotTradingRoutingModule() {
        _classCallCheck(this, UserSpotTradingRoutingModule);
      });

      UserSpotTradingRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function vmZF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=user-spot-trading-user-spot-trading-module-es5.js.map