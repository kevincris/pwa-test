(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["registration-registration-module"], {
    ...
    /***/
    function i1G(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function h9V(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function KK(module, __webpack_exports__, __webpack_require__) {
      ...
      var _common_countries__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ../common/countries */
      "Gq6/");
      /* harmony import */


      var _common_services_alert_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ../common/services/alert.service */
      "0ZVX");
      /* harmony import */


      var _common_services_login_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      ...
      var _common_user_details_form_user_details_form_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ../common/user-details-form/user-details-form.component */
      "4pyo");
      /* harmony import */


      var _email_verification_modal_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ./email-verification-modal.component */
      "qPTY");
      /* harmony import */


      var _registration_notice_registration_notice_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! ./registration-notice/registration-notice.component */
      "QMST");

      var RegistrationComponent = /*#__PURE__*/function () {
        function RegistrationComponent(router, route, http, alertService, loginService, ngbModal, translate) {
          ...
          this.referredByOptions = ["".concat(this.translate.instant('registration.friend-relative')), "".concat(this.translate.instant('registration.business-contact')), "".concat(this.translate.instant('registration.corporate-service-provider')), "Authorised Partner of ".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_12__["environment"].displayName), 'Other'];
        ...
        _createClass(RegistrationComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.queryParamMap.subscribe(function (params) {
              ...
              _this.activationToken = params.get('activationToken') || undefined;
              Object.assign(_this.user, {
                id: params.get('userId') || undefined,
                email: params.get('email') || undefined
              });

              if (_this.user.id && _this.activationToken) {
                _this.http.get("/users/".concat(_this.user.id), {
                  headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                    'X-Activation-Token': _this.activationToken
                  })
                }).subscribe(function (user) {
                  var _a;

                  Object.assign(_this.user, Object(lodash__WEBPACK_IMPORTED_MODULE_9__["pick"])(user, ['type', 'email', 'details']));
                  _this.details = _this.user.details || {};
                  _this.business = ((_a = _this.user.details) === null || _a === void 0 ? void 0 : _a.business) || {};
                  _this.birthday = _this.details.birthday ? Object(date_fns_format__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(date_fns_parseISO__WEBPACK_IMPORTED_MODULE_8__["default"])(_this.details.birthday), 'ddMMyyyy') : null;
                  _this.isInvitation = !!user.email;
                }, function () {
                  _this.alertService.add({
                    severity: 'danger',
                    message: _this.translate.instant('common.invitation-expired')
                  });
              ...
              if (params.has('referrerId')) {
                _this.referrerId = params.get('referrerId');

                _this.http.get("/referrers/".concat(_this.referrerId)).subscribe(function (referrer) {
                  _this.referrer = referrer;
                }, function () {
                  _this.referrerId = undefined;
                  _this.referrer = null;
                });
              }

              _this.externalId = (_a = params.get('externalId')) !== null && _a !== void 0 ? _a : undefined;
            });
            this.subscriptions.add(this.http.get("/settings/registration-disabled").subscribe(function (setting) {
              _this.isRegistrationDisabled = setting && setting.value;
            }));
          }
        }, {
          key: "ngAfterViewInit",
          value: function ngAfterViewInit() {
            ...
            setTimeout(function () {
              if (_this2.appName === 'sgpmx') {
                _this2.openNoticeModal();
              }
            }, 200);
          }
        }, {
          ...
          value: function submit() {
            ...
            var body = Object.assign(Object.assign({}, this.user), {
              details: Object.assign(Object.assign(Object.assign({}, this.details), {
                birthday: this.birthday ? Object(_common_user_details_form_user_details_form_component__WEBPACK_IMPORTED_MODULE_17__["formatMaskedDate"])(this.birthday) : null
              }), this.user.type === 'business' ? {
                business: this.business
              } : {}),
              externalId: (_a = this.externalId) !== null && _a !== void 0 ? _a : undefined
            });
            ...
            this.isLoading = true;
            this.http.post('/users', Object(lodash__WEBPACK_IMPORTED_MODULE_9__["omit"])(body, ['id']), {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["flatMap"])(function (user) {
              return _this3.isInvitation ? _this3.loginService.login({
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 5:
                        this.reset();
                        modal = this.ngbModal.open(_email_verification_modal_component__WEBPACK_IMPORTED_MODULE_18__["EmailVerificationModalComponent"], {
                          backdrop: 'static',
                          keyboard: false,
                          centered: true
                        });
              ...
              if (error.name === 'UniqueConstraintError') {
                switch (error.errors[0]) {
                  case 'email must be unique':
                    _this3.alertService.add({
                      severity: 'danger',
                      message: _this3.translate.instant('common.email-already-in-use')
                    });
          ...
          value: function openTermsModal() {
            ...
            var termsModal = this.ngbModal.open(_common_terms_modal_terms_modal_component__WEBPACK_IMPORTED_MODULE_16__["TermsModalComponent"], {
              windowClass: 'modal-primary',
              backdrop: 'static',
              keyboard: false
            });
            var termsModalComponent = termsModal.componentInstance;
            termsModalComponent.user = this.user;
            termsModal.result.then(function () {
              _this5.termsAccepted = true;
              _this5.hasReadTerms = true;
            })["catch"](function () {
              _this5.termsAccepted = false;
            });
          }
        }, {
          key: "onAcceptTerms",
          value: function onAcceptTerms(accepted, ngModel) {
          ...
          key: "openNoticeModal",
          value: function openNoticeModal() {
    ...
    function k1(module, __webpack_exports__, __webpack_require__) {
      ...
      var FeesQuery = /*#__PURE__*/function (_datorama_akita__WEBP2) {
        ...
        function FeesQuery(store) {
          ...
          _this6 = _super2.call(this, store);
          _this6.store = store;
          return _this6;
        }
        ...
        _createClass(FeesQuery, [{
          ...
          value: function findByPrimaryAttributes(query) {
            ...
            return this.selectEntity(function (entity) {
              ...
              return fee ? Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(fee) : _this7.selectEntity(function (entity) {
    ...
    function DNuw(module, __webpack_exports__, __webpack_require__) {
      ...
      var _common_terms_modal_terms_modal_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../common/terms-modal/terms-modal.module */
      "d7hY");
      /* harmony import */


      var _email_verification_modal_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./email-verification-modal.component */
      "qPTY");
      /* harmony import */


      var _registration_notice_registration_notice_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./registration-notice/registration-notice.component */
      "QMST");
      /* harmony import */


      var _registration_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./registration-routing.module */
      "zF/k");
      /* harmony import */


      var _registration_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    /***/
    function ItCr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function QMST(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RegistrationNoticeComponent", function () {
        return RegistrationNoticeComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_registration_notice_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./registration-notice.component.html */
      "ReAF");
      /* harmony import */
      ...
      var RegistrationNoticeComponent = /*#__PURE__*/_createClass(function RegistrationNoticeComponent(modal) {
        _classCallCheck(this, RegistrationNoticeComponent);

        this.modal = modal;
      });

      RegistrationNoticeComponent.ctorParameters = function () {
        return [{
          type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbActiveModal"]
        }];
      };

      RegistrationNoticeComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    /***/
    function ReAF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function U2ib(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SgpmxTermFeesComponent", function () {
        return SgpmxTermFeesComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_sgpmx_term_fees_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./sgpmx-term-fees.component.html */
      "ItCr");
      /* harmony import */
      ...
      var src_app_store_fees_fees_query__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/store/fees/fees.query */
      "80k1");
      /* harmony import */


      var src_app_store_fees_fees_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var SgpmxTermFeesComponent = /*#__PURE__*/function () {
        function SgpmxTermFeesComponent(session, route, http, feesQuery, feesService) {
          _classCallCheck(this, SgpmxTermFeesComponent);
        ...
        _createClass(SgpmxTermFeesComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this8 = this;

            this.subscriptions.add(Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(undefined).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(function () {
              _this8.isLoading = true;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(function () {
              return _this8.session.isAuthenticated() ? _this8.session.userStream : Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(undefined);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["flatMap"])(function (sessionUser) {
              var referrerId = _this8.route.snapshot.queryParamMap.get('referrerId');

              var activationToken = _this8.route.snapshot.queryParamMap.get('activationToken');

              var user = _this8.user || sessionUser;
              var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
              ...
              return user && user.id ? Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["forkJoin"])([_this8.http.get("/users/".concat(user.id, "/fee-schedule"), {
                params: {
                  currencyCode: 'AU'
                },
                headers: headers
              }), _this8.http.get("/users/".concat(user.id, "/fee-schedule"), {
                params: {
                  currencyCode: 'AG'
                },
                headers: headers
              })]) : Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["forkJoin"])([_this8.http.get("/fee-schedule", {
                params: referrerId ? {
                  currencyCode: 'AU',
              ...
              _this8.fees = [].concat(_toConsumableArray(goldFees), _toConsumableArray(silverFees));
      ...
      SgpmxTermFeesComponent.ctorParameters = function () {
        return [{
      ...
      SgpmxTermFeesComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function VrA6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var TermsModalComponent = /*#__PURE__*/function () {
        function TermsModalComponent(activeModal, translate, session, termsService, element) {
          ...
          this.scrollHandler = function () {
            // 25px threshold
            if (_this9.modalContainer.scrollTop >= _this9.modalContainer.scrollHeight - _this9.modalContainer.offsetHeight - 25) {
              _this9.isDown = true;
            } else {
              _this9.isDown = false;
            }
        ...
        _createClass(TermsModalComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.subscriptions.add(this.fetchEvent.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function () {
              return _this10.session.isAuthenticated() ? _this10.session.userStream : Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(undefined);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["flatMap"])(function (user) {
              return _this10.termsService.getApplicableTerm(user === null || user === void 0 ? void 0 : user.id);
            })).subscribe(function (term) {
              _this10.term = term;
              setTimeout(function () {
                return _this10.scrollHandler();
              });
            }));
    ...
    /***/
    function d7hY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TermsModalModule", function () {
        return TermsModalModule;
      });
      /* harmony import */
      ...
      var _sgpmx_term_fees_sgpmx_term_fees_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./sgpmx-term-fees/sgpmx-term-fees.component */
      "U2ib");
      /* harmony import */


      var _term_fees_term_fees_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./term-fees/term-fees.component */
      "eT9F");
      /* harmony import */


      var _terms_modal_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./terms-modal.component */
      "aXE1");

      var TermsModalModule = /*#__PURE__*/_createClass(function TermsModalModule() {
        _classCallCheck(this, TermsModalModule);
      });

      TermsModalModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function eT9F(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TermFeesComponent", function () {
        return TermFeesComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_term_fees_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./term-fees.component.html */
      "2h9V");
      /* harmony import */
      ...
      var _models_accounting_currency_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var TermFeesComponent = /*#__PURE__*/function () {
        function TermFeesComponent(http, session, route) {
          _classCallCheck(this, TermFeesComponent);
        ...
        _createClass(TermFeesComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this11 = this;
            ...
            this.http.get('/currencies', {
              ...
              _this11.currency = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["find"])(_this11.currencies, {
                code: _this11.session.user ? _this11.session.user.preferredCurrency.code : 'USD'
              });

              _this11.fetchEvent.next();
            });
            this.subscriptions.add(this.fetchEvent.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(function () {
              _this11.isLoading = true;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(function () {
              return _this11.session.isAuthenticated() ? _this11.session.userStream : Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(undefined);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["flatMap"])(function (sessionUser) {
              var params = {
                currencyCode: _this11.currency.code
              };

              var referrerId = _this11.route.snapshot.queryParamMap.get('referrerId');

              var user = _this11.user || sessionUser;

              var activationToken = _this11.route.snapshot.queryParamMap.get('activationToken');
              ...
              return user && user.id ? _this11.http.get("/users/".concat(user.id, "/fee-schedule"), {
                params: params,
                headers: headers
              }) : _this11.http.get("/fee-schedule", {
                params: referrerId ? Object.assign(Object.assign({}, params), {
                  referrerId: referrerId
                }) : params
              });
          ...
          value: function getFee(type, method) {
            var found = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["find"])(this.fees, function (fee) {
          ...
          value: function convert(amount, baseCurrency) {
            ...
            var counter = this.currencies.find(function (currency) {
              return currency.code === _this12.currency.code;
            });
      ...
      TermFeesComponent.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
        }, {
          type: _services_session_service__WEBPACK_IMPORTED_MODULE_9__["SessionService"]
      ...
      TermFeesComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'term-fees',
    ...
    /***/
    function qPTY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EmailVerificationModalComponent", function () {
        return EmailVerificationModalComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_email_verification_modal_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./email-verification-modal.component.html */
      "VrA6");
      /* harmony import */
      ...
      var EmailVerificationModalComponent = /*#__PURE__*/_createClass(function EmailVerificationModalComponent(modal) {
        _classCallCheck(this, EmailVerificationModalComponent);

        this.modal = modal;
      });

      EmailVerificationModalComponent.ctorParameters = function () {
        return [{
          type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbActiveModal"]
        }];
      };

      EmailVerificationModalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    /***/
    function z8Oq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RegistrationAuthGuard", function () {
        return RegistrationAuthGuard;
      });
      /* harmony import */
      ...
      var RegistrationAuthGuard = /*#__PURE__*/function () {
        function RegistrationAuthGuard(session, router) {
          _classCallCheck(this, RegistrationAuthGuard);

          this.session = session;
          this.router = router;
        }

        _createClass(RegistrationAuthGuard, [{
          key: "canActivate",
      ...
      RegistrationAuthGuard.ctorParameters = function () {
        return [{
      ...
      RegistrationAuthGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], RegistrationAuthGuard);
      /***/
    },
    ...
    function zFK(module, __webpack_exports__, __webpack_require__) {
      ...
      var _registration_auth_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./registration.auth-guard */
      "z8Oq");
      /* harmony import */


      var _registration_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./registration.component */
      "4K/k");
      ...
      var RegistrationRoutingModule = /*#__PURE__*/_createClass(function RegistrationRoutingModule() {
