(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-admin-module~user-spot-trading-user-spot-trading-module"], {
    ...
    /***/
    function ajw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function B25w(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SpotTradingModule", function () {
        return SpotTradingModule;
      });
      /* harmony import */
      ...
      var ngx_countdown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ngx-countdown */
      "z+xu");
      /* harmony import */
      ...
      var _common_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../common.module */
      "a6Df");
      /* harmony import */


      var _spot_trading_feed_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./spot-trading-feed.component */
      "uQ2D");
      /* harmony import */


      var _spot_trading_form_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./spot-trading-form.component */
      "JmQh");
      /* harmony import */


      var _spot_trading_quote_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./spot-trading-quote-modal.component */
      "pfSy");

      var SpotTradingModule = /*#__PURE__*/_createClass(function SpotTradingModule() {
        _classCallCheck(this, SpotTradingModule);
      });

      SpotTradingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function JmQh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SpotTradingFormComponent", function () {
        return SpotTradingFormComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_spot_trading_form_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./spot-trading-form.component.html */
      "8ajw");
      /* harmony import */
      ...
      var src_app_store_wallets_wallets_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var _spot_trading_quote_modal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./spot-trading-quote-modal.component */
      "pfSy");

      var SpotTradingFormComponent = /*#__PURE__*/function () {
        function SpotTradingFormComponent(http, session, toastr, walletsService, ngbModal) {
          var _this = this;

          _classCallCheck(this, SpotTradingFormComponent);
          ...
          this.usersStream = this.userAutocomplete.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (search) {
        ...
        _createClass(SpotTradingFormComponent, [{
          key: "requestQuote",
          value: function requestQuote() {
            var _this2 = this;

            var _a, _b;

            this.isLoading = true;
            this.http.post('/spot-trades/request-for-quote', Object.assign(Object.assign({}, this.copy), {
              ...
              _this2.openQuoteModal(response);
            });
          }
        }, {
          key: "executeTrade",
          value: function executeTrade(trade) {
            var _this3 = this;

            var _a, _b;

            this.isLoading = true;
            this.http.post('/spot-trades', Object.assign(Object.assign({}, trade), {
              userId: (_b = (_a = this.user) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : this.session.user.id
            })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
              _this3.isLoading = false;
            })).subscribe(function () {
              _this3.toastr.success('Trade executed');

              if (_this3.spotTradeForm) {
                _this3.spotTradeForm.form.markAsUntouched();
              }

              _this3.copy = {
                side: trade.side,
                instrument: _this3.instruments[0]
              };

              _this3.walletsService.fetch();

              _this3.onExecuteTrade.next();
            });
          }
        }, {
          key: "openQuoteModal",
          value: function openQuoteModal(trade) {
            var _this4 = this;

            var modal = this.ngbModal.open(_spot_trading_quote_modal_component__WEBPACK_IMPORTED_MODULE_9__["SpotTradingQuoteModalComponent"], {
            ...
            component.onExecute.subscribe(function () {
              ...
              _this4.executeTrade(trade);
            });
          }
        }, {
          key: "getBaseCurrency",
          value: function getBaseCurrency(instrument) {
            if (!instrument) {
              return '';
            }
          ...
          key: "buildCurrencyPair",
          value: function buildCurrencyPair(instrument) {
            if (!instrument) {
              return '';
            }

            var parts = instrument.split('.');
            return "".concat(parts[0].slice(0, 3), " / ").concat(parts[0].slice(3, 6));
          }
        }]);
      ...
      SpotTradingFormComponent.ctorParameters = function () {
        return [{
      ...
      SpotTradingFormComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function LNGT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TrendModule", function () {
        return TrendModule;
      });
      /* harmony import */
          ...
          value: function ngOnChanges() {
            ...
            this.gradientTrimmed = this.gradient.slice().reverse().map(function (val, idx) {
              return {
                idx: idx,
                stopColor: val,
                offset: normalize(idx, 0, _this5.gradient.length - 1 || 1)
              };
            });
            ...
            if (this.autoDraw && this.animationState !== 'active') {
              ...
              setTimeout(function () {
                _this5.lineLength = _this5.pathEl.nativeElement.getTotalLength();
                _this5.animationState = 'active';
              });
            }
      ...
      TrendComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: TrendComponent,
        selectors: [["ngx-trend"]],
        ...
        encapsulation: 2,
        data: {
          animation: [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])('pathAnimaiton', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["state"])('inactive', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["style"])({
            display: 'none'
          })), Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["transition"])('* => active', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["style"])({
            display: 'initial'
          }), // We do the animation using the dash array/offset trick
          // https://css-tricks.com/svg-line-animation-works/
          Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["animate"])('{{ autoDrawDuration }}ms {{ autoDrawEasing }}', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["keyframes"])([Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["style"])({
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](TrendComponent, [{
          ...
          args: [{
            ...
            animations: [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])('pathAnimaiton', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["state"])('inactive', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["style"])({
              display: 'none'
            })), Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["transition"])('* => active', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["style"])({
              display: 'initial'
            }), // We do the animation using the dash array/offset trick
      ...
      TrendModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
        type: TrendModule
      });
      TrendModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](TrendModule, {
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](TrendModule, [{
    ...
    /***/
    function Z9rc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function iEmy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function pfSy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SpotTradingQuoteModalComponent", function () {
        return SpotTradingQuoteModalComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_spot_trading_quote_modal_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./spot-trading-quote-modal.component.html */
      "ajEU");
      /* harmony import */
      ...
      var bignumber_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! bignumber.js */
      "kB5k");
      /* harmony import */


      var bignumber_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(bignumber_js__WEBPACK_IMPORTED_MODULE_4__);
      /* harmony import */


      var date_fns_differenceInSeconds__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! date-fns/differenceInSeconds */
      "qVkf");
      /* harmony import */


      var _services_confirmation_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../services/confirmation.service */
      "fTmd");

      var SpotTradingQuoteModalComponent = /*#__PURE__*/function () {
        function SpotTradingQuoteModalComponent(activeModal, confirmation) {
          _classCallCheck(this, SpotTradingQuoteModalComponent);
        ...
        _createClass(SpotTradingQuoteModalComponent, [{
          key: "ngOnInit",
          ...
          key: "baseCurrency",
          get: function get() {
            var parts = this.trade.instrument.split('.');
            return parts[0].slice(0, 3);
          }
        }, {
          key: "counterCurrency",
          ...
          key: "onCountdownEvent",
          value: function onCountdownEvent(event) {
            if (event.action === 'done') {
              this.activeModal.dismiss(); // TODO: Just renew quote instead of show expiry
      ...
      SpotTradingQuoteModalComponent.ctorParameters = function () {
        return [{
      ...
      SpotTradingQuoteModalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    /***/
    function uQ2D(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SpotTradingFeedComponent", function () {
        return SpotTradingFeedComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_spot_trading_feed_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./spot-trading-feed.component.html */
      "Z9rc");
      /* harmony import */


      var _spot_trading_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./spot-trading.component.scss */
      "iEmy");
      /* harmony import */
      ...
      var SpotTradingFeedComponent = /*#__PURE__*/function () {
        function SpotTradingFeedComponent(http) {
          _classCallCheck(this, SpotTradingFeedComponent);
        ...
        _createClass(SpotTradingFeedComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this6 = this;

            this.http.get('/spot-trades/rates').subscribe(function (rates) {
              return _this6.rates = rates;
            });
          }
        }, {
          key: "getDailyChange",
          value: function getDailyChange(ticker) {
            var _a;
          ...
          key: "getWeeklyChange",
          value: function getWeeklyChange(ticker) {
            var _a;
          ...
          key: "getTrend",
          value: function getTrend(ticker) {
            return this.rates && this.rates.data[ticker].trend_7d;
          }
        }, {
          key: "getPrice",
          value: function getPrice(ticker) {
            return (this.rates && this.rates.data[ticker].current_price || 1).toFixed(2);
          }
        }, {
          key: "getPriceSide",
          value: function getPriceSide(ticker, side) {
            var spread = side === 'buy' ? '1.04' : '0.96';
      ...
      SpotTradingFeedComponent.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]
        }];
      };

      SpotTradingFeedComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
...
//# sourceMappingURL=default~admin-admin-module~user-spot-trading-user-spot-trading-module-es5.js.map